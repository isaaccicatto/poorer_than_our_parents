function [ys,params,check] = ext_path_A_repl_steadystate(ys,exo,M_,options_)
check = 0;
...
gamma_A = exo(1); phi_A = exo(2); R_star = exo(3); repl = exo(5); pen_bar = exo(6);
% 1. Demographics
...
b_A = b_y * y_A;
gov_A = g_y * y_A;
e_A = (repl * w_A / tilde_s_m_A + pen_bar) * tilde_s_o_A;
