function [ys,params,check] = ext_path_MM_repl_steadystate(ys,exo,M_,options_)
check = 0;
...
gamma_MM = exo(1); phi_MM = exo(2); R_star = exo(3); repl = exo(5); pen_bar = exo(6);
% 1. Demographics
...
b_MM = b_y * y_MM;
gov_MM = g_y * y_MM;
e_MM = (repl * w_MM / tilde_s_m_MM + pen_bar) * tilde_s_o_MM;
